...
class ServiceNowConnector {
   ...
   */
    ...
    * @summary Checks if ServiceNow instance is hibernating
    ...
    * @summary Inspect ServiceNow API response for an error, bad response code, or a hibernating instance
    ...
    * @memberof ServiceNowConnector
    * @method sendRequest
    * @summary Builds final options argument for request function
    * @description Builds final options argument for request function from global const options and parameter callOptions.
    ...
    * @param {iapCallback} callback - Callback a function.
    * @param {(object|string)} callback.data - The API's response. Will be an object if sunnyday path. Will be HTML text if hibernating instance.
    * @param {error} callback.error - The error property of callback.
    */
